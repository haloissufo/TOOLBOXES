...
%
AVISO_DIR='/Volumes/HALO2014/AVISO20YEARS/delayed-time/grids/madt/all-sat-merged/h/MADT1993-2015_RENAME';
%
%AVISO_DIR='/sea/data/nansen/issufo/DATASETS/MADT1993-2013_RENAME';
%AVISO_DIR='../data';
AVISO_TYPE='madt';
...
%
usetopo=0; % option: 0 do not use the topo (a topography file should be provided)
%usetopo=1; % option: 1 to use the topo (a topography file should be provided)
hmin=50;
%
TOPODIR = '/Users/hayley/WorkDir/ocean_modelling/croco_old/Topo/';
topofile = [TOPODIR,'gebco1.nc'];
% 
% Eddies file name
%
