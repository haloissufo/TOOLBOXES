...
ngood=0;
for i=1:max(ID_all)
%for i=[134, 214, 301];       %01Feb-31Jun2013
%for i=[629, 761, 807, 811];   %01Jul-31Oct2013
%for i=[1412, 1485, 1490, 1593];   %01Oct-31Dec2013
...
%
  m_proj('mercator',...
       'lon',[lonmin lonmax],...
       'lat',[latmin latmax]);
  h2=m_contourf(lon,lat,100*zeta,[zmin:dz:zmax],'k');
  shading flat
  colorbar
  hold on
%
